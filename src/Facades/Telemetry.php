 ...
 * @method static void ignorePaths(string|list<string> $patterns)
 * @method static list<string> ignoredPaths()
 * @method static bool ignoresPath(string $path)
 ...
 * @method static \Cbox\Telemetry\Support\ExportReport flush(bool $forceDetails = false)
 * @method static \Cbox\Telemetry\Support\ExportReport flushMetrics()
 * @method static \Cbox\Telemetry\Support\ExportReport ingestSpans(list<\Cbox\Telemetry\Tracing\Span> $spans)
 * @method static \Cbox\Telemetry\Support\ExportReport ingestEvents(list<\Cbox\Telemetry\Events\TelemetryEvent> $events)
