---
title: Cookbook
description: Cookbook documentation.
weight: 1
---

# Cookbook

- **[Cookbook: Multi-tenant SaaS](multi-tenant-saas.md)** — Per-tenant business metrics without blowing up cardinality
- **[Cookbook: Queue monitoring](queue-monitoring.md)** — Depth, throughput, latency and in-flight gauges for queues
